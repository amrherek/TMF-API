...
public class BscsCommonDomainServiceAdapterIXR2Test {

    @Autowired
    private BscsCommonDomainServiceAdapter adapter;
    ...
    @Test
    public void getCountries_ok() {
        List<BscsCountry> countries = adapter.getCountries();

...
public class BscsBusinessTransactionSearchV8 extends BscsBusinessTransactionSearch {

    public BscsBusinessTransactionSearchV8(BusinessTransaction transaction) {
        super(transaction);
    }

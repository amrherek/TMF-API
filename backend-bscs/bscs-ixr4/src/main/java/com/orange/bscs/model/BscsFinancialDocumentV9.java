...
public class BscsFinancialDocumentV9 extends BscsFinancialDocument {

    public BscsFinancialDocumentV9(BSCSDocuments document) {
        super(document);
    }
    ...
    public String getCode() {
        // DOCUMENT_CODE
        return document.getStringValue("DOCUMENT_CODE");
    }
    ...
    public String getType() {
        return document.getStringValue("DOC_TYPE");
    }

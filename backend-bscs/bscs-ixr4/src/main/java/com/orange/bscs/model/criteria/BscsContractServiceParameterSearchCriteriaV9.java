...
public class BscsContractServiceParameterSearchCriteriaV9 extends BscsContractServiceParameterSearchCriteria {

    public BscsContractServiceParameterSearchCriteriaV9() {
        super();
    }

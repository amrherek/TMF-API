...
public class BscsUsageDataRecordSearchCriteriaV9 extends BscsUsageDataRecordSearchCriteria {

    public BscsUsageDataRecordSearchCriteriaV9() {
        super();
    }
    ...
    public void setContractId(String contractId) {
        // CO_ID_PUB
        recordCriteria.setCoIdPub(contractId);
    }

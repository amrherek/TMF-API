...
public class BscsAddressV9 extends BscsAddress {

    public BscsAddressV9(BSCSAddress address) {
        super(address);
    }

    public BscsAddressV9() {
        super();
    }
    ...
    public String getCustomerId() {
        // CS_ID_PUB
        return address.getCustomerIdPub();
    }

    @Override
    public void setCustomerId(String customerId) {
        // CS_ID_PUB
        address.setCustomerIdPub(customerId);
    }

...
public class BscsMarketSegmentServiceAdapterV9Test {
    ...
    public void getCustomerInfo_ok() throws BscsInvalidIdException {
        BscsCustomerInfo customerInfo = adapter.getCustomerInfo("CUST0000084286");
    ...
    public void writeCustomerInfo_ok() throws BscsInvalidIdException, BscsInvalidFieldException {
        ...
        info.setCustomerId("CUST0000084286");
